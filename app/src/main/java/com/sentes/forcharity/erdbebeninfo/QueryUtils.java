...
import static com.sentes.forcharity.erdbebeninfo.EarthquakeActivity.LOG_TAG;
...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            JSONArray eqArray = object.optJSONArray("features");
            for(int i = 0; i < eqArray.length(); i++) {
                JSONObject current = eqArray.getJSONObject(i);
