...
public class EarthquakeAdapter extends ArrayAdapter<Earthquake> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        magnitudeView.setText(formatMag(currentEq.getmMagnitude()));

        //Time & Date
        Date dateObject = new Date(currentEq.getmTimeInMilliseconds());
        ...
        //Location & Offset
        String originalLocation = currentEq.getmLocation();
        ...
        int magnitudeColor = getMagnitudeColor(currentEq.getmMagnitude());
    ...
    private String formatMag(double mag) {
        ...
        String magFormatted = formatter.format(mag);
        return magFormatted;
    }
}
